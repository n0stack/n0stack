...
func (*CreateEmptyBlockStorageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{0}
}
...
func (*CreateEmptyBlockStorageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{1}
}
...
func (*FetchBlockStorageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{2}
}
...
func (*FetchBlockStorageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{3}
}
...
func (*DeleteBlockStorageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{4}
}
...
func (*ResizeBlockStorageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_agent_c114ac845e97ea9e, []int{5}
}
...
func (dst *ResizeBlockStorageRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResizeBlockStorageRequest.Merge(dst, src)
}
...
func (c *blockStorageAgentServiceClient) ResizeBlockStorage(ctx context.Context, in *ResizeBlockStorageRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := grpc.Invoke(ctx, "/n0stack.internal.n0core.provisioning.blockstorage.BlockStorageAgentService/ResizeBlockStorage", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() {
	proto.RegisterFile("pkg/api/provisioning/blockstorage/agent.proto", fileDescriptor_agent_c114ac845e97ea9e)
}

var fileDescriptor_agent_c114ac845e97ea9e = []byte{
