...
func TestBootUbuntu(t *testing.T) {
	...
	key, _, _, _, _ := ssh.ParseAuthorizedKey([]byte("ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBMwfns/Woug7RBC3YjRbXecM/4LGVb5S1u8muo2v3ealA5mX2fnAKUssQY84XXE08m18nnWClVWU2goUsVtlgp0= testkey"))
