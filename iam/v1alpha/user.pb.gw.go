...
var (
	pattern_UserService_CreateUser_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "iam", "v1alpha", "users"}, "", runtime.AssumeColonVerbOpt(true)))
